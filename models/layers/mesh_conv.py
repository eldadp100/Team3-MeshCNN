    ...
    def forward(self, x):
        ...
        for i in range(N):
            ...
            if add_patch:
                ...
                rest_seq_padded = torch.zeros(1, curr_x_patches.shape[1], curr_x_patches.shape[2])
...
class MeshSA(nn.Module):
    ...
    def forward(self, edges_features):
        ...
        return out.permute(0, 2, 1)  # permute back
...
if __name__ == '__main__':
    sa_layer = SA_Layer(10, 16)
    a = torch.rand(32, 5, 10)  # seq of 5 elems
    print(sa_layer(a))
